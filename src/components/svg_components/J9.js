  ...
  >
    ...
    <G opacity={0.83}>
      <LinearGradient
        ...
        gradientTransform="translate(0 600)"
      >
        <Stop offset={0} stopColor="#9b9b02" />
        <Stop offset={0.102} stopColor="#aeae31" />
        <Stop offset={0.2333} stopColor="#c3c367" />
        <Stop offset={0.366} stopColor="#d5d596" />
        <Stop offset={0.4975} stopColor="#e4e4bc" />
        <Stop offset={0.6276} stopColor="#f0f0d9" />
        <Stop offset={0.7556} stopColor="#f8f8ee" />
        <Stop offset={0.8808} stopColor="#fdfdfb" />
        <Stop offset={1} stopColor="#fff" />
      </LinearGradient>
      <Path
    ...
    <G opacity={0.18}>
      ...
      <Path d="M332 221H622V685H332z" fill="url(#h)" />
      <LinearGradient
        id="i"
        gradientUnits="userSpaceOnUse"
        x1={1100.5}
      ...
      <Path d="M750.5 100.5L622 221 332 221 250.5 100.5z" fill="url(#i)" />
      <LinearGradient
        id="j"
        gradientUnits="userSpaceOnUse"
        x1={981.0842}
      ...
      <Path d="M750.5 100.5L622 221 621 685 750.5 900.5z" fill="url(#j)" />
      <G>
        <LinearGradient
          id="k"
          gradientUnits="userSpaceOnUse"
        ...
        <Path d="M750.5 900.5L250.5 900.5 332 685 621 685z" fill="url(#k)" />
      </G>
      <G>
        <LinearGradient
          id="l"
        ...
        <Path d="M332 221L250.5 100.5 250.5 900.5 332 685z" fill="url(#l)" />
      </G>
    </G>
    <G opacity={0.22}>
      <G display="none">
      ...
      <G opacity={0.75}>
        ...
        <Path d="M379 221H669V685H379z" fill="url(#m)" />
      </G>
      <G opacity={0.75}>
        <LinearGradient
          id="n"
        ...
        <Path d="M250.5 100.5L379 221 669 221 750.5 100.5z" fill="url(#n)" />
      </G>
      <G opacity={0.74}>
        <LinearGradient
          id="o"
        ...
        <Path d="M669 221L750.5 100.5 750.5 900.5 669 685z" fill="url(#o)" />
      </G>
    </G>
    <G>
      <G opacity={0.6}>
